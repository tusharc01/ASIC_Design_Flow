...
# Generated on: Tue Apr 01 17:44:25 IST 2025 (Tue Apr 01 12:14:25 UTC 2025)
...
set_log_file /home/nitrkl9/Documents/lock_files/PhysicalDesign/Syn/logs/intermediate2final_c.lec.log -replace

usage -auto -elapse

set_verification_information fv_map_lock_incrementalv_db

read_implementation_information fv/lock -golden fv_map -revised lock_incrementalv
...
read_design -verilog95   -golden -lastmod -noelab fv/lock/fv_map.v.gz
elaborate_design -golden -root {lock}

read_design -verilog95   -revised -lastmod -noelab /home/nitrkl9/Documents/lock_files/PhysicalDesign/Syn/output_files/lock_incremental.v
elaborate_design -revised -root {lock}

#add_name_alias fv/lock/fv_map.singlebit.original_name.alias.json.gz -golden
...
#add_name_alias fv/lock/lock_incrementalv.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles /home/nitrkl9/Documents/lock_files/PhysicalDesign/Syn/logs/intermediate2final_c.lec.log
}
